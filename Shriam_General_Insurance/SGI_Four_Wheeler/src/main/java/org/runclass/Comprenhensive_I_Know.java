...
//up2  this----------------------------->
                ...
                driver.findElement(By.xpath("//div[@class='col-md-4 col-lg-6 layout-left hide-md']")).click();
...
//					ls.getNcbbonus_45btn().click();
                    ...
                    driver.findElement(By.xpath("(//button[@class='primary-btn modal-close-btn mx-auto mt-20 x-icon'])[9]")).click();
//                    ls.getHere_your_plan_info_closebtn_page4().click();
...
//                    ls.getExtra_protection_popup_closebtn_page4().click();
                    driver.findElement(By.xpath("(//button[@class='primary-btn modal-close-btn mx-auto mt-20 x-icon'])[12]")).click();
                    Thread.sleep(2000);
