...
public class ExcelUtils {
	...
	public static ArrayList<Object[]> getDataFromexcel() {
		...
		try {
			String Excel_Name="C:\\Users\\a1354\\eclipse-workspace\\sgi-automation\\New_SGI\\Excel\\Sit_Sgi.xlsx";
		...
		for (int rowNum = 2; rowNum <= reader.getRowCount("Sheet1"); rowNum++) {
			...
			Object ob[] = { Car_no,  Mobile_Number,  OTP_1,  OTP_2,  OTP_3,  OTP_4,  OTP_5,
					 ...
					 INDEX,    Third_Party_Insurer,  Third_Party_Policy_Start_Date,Own_Damage_Policy_Start_Date,
					 Third_Party_Policy_Number,  Own_Damage_Insurer,  Own_Damage_Policy_Number,  Flow_type};
			myData.add(ob);
		}
		return myData;
	...
	public static void writeinexcel(String value, int INDEX) throws Exception {
		Thread.sleep(2000);
        File fis = new File(
                "C:\\Users\\a1354\\eclipse-workspace\\sgi-automation\\New_SGI\\Excel\\Sit_Sgi.xlsx");
