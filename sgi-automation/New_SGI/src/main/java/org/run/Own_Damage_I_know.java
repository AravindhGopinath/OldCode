...
public class Own_Damage_I_know {
	...
	public static void Owd_Flow(String select_previous_policy_type, String Ea_Enter_accessories_name,
			String Ea_Enter_accessories_amount, String NEa_Enter_accessories_name, String NEa_Enter_accessories_amount,
			String Enter_amount, String Full_name, String Email, String Ad_line1, String Ad_line2, String Pincode,
			String Loan_Provider, String Financier_Branch, String Chassis_Number, String Engine_Number,
			String Nominee_name, String Nominee_age, String Insurer, String Policy_Number, String Policy_Expiry_Date,
			String Vehicle_number, String Make_and_model, String Variant, String city_of_registration,
			String Select_registration, String Enter_company_name, String Enter_GST_number,
			String Third_Party_Insurer, String Third_Party_Policy_Start_Date,String Own_Damage_Policy_Start_Date,
			String Third_Party_Policy_Number, String Own_Damage_Insurer, String Own_Damage_Policy_Number,
			String previous_policy_expiry_date, String INDEX, String Iteration, String OTP_1, String OTP_2,
			String OTP_3, String OTP_4, String Car_no, String Mobile_Number) throws Exception {
		...
		try {
				...
				if (s.equals("Own Damage")) {
					...
					if (state_textbox.isDisplayed()) {
						...
						if (chasis.isDisplayed() == false) {
							...
							Third_Party_Policy_Number1.click();
							...
							Own_Damage_Policy_Number1.click();
			...
			// _________________________________________I-Know-Reg-Flow[Without Zoopdata]________________________________________________
				...
				findElement2.sendKeys(previous_policy_expiry_date);
				...
				if (s1.equals("Own Damage")) {
					...
					if (ncbeditbtn_page4.isDisplayed()) {
						...
						driver.findElement(
								By.xpath("(//button[@class='primary-btn modal-close-btn mx-auto mt-20 x-icon'])[9]"))
								.click();
						...
						driver.findElement(
								By.xpath("(//button[@class='primary-btn modal-close-btn mx-auto mt-20 x-icon'])[11]"))
								.click();
						...
						driver.findElement(
								By.xpath("(//button[@class='primary-btn modal-close-btn mx-auto mt-20 x-icon'])[13]"))
								.click();
